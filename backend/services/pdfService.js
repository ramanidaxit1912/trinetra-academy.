...
<body>
  ...
  <div class="pdf-page-frame" style="text-align: center; display: flex; flex-direction: column; justify-content: space-between; height: 100%; box-sizing: border-box; padding: 12px 16px;">
    ...
    <div style="flex: 1 1 auto; display: flex; align-items: center; justify-content: center; margin: 4px 0; min-height: 0;">
      ${displayPosters.length === 1 ? `
        <div style="border: 2.5px solid #d97706; outline: 1.5px solid #1e3a8a; border-radius: 12px; overflow: hidden; background: #ffffff; box-shadow: 0 6px 22px rgba(0,0,0,0.12); width: 100%; max-width: 530px; display: flex; align-items: center; justify-content: center; padding: 4px; box-sizing: border-box;">
          ${displayPosters[0].imageDataUrl ? `
            <img src="${displayPosters[0].imageDataUrl}" style="max-height: 520px; max-width: 100%; width: auto; height: auto; object-fit: contain; display: block; border-radius: 8px;" alt="${displayPosters[0].title}" />
          ` : `
            <div style="padding: 40px; font-weight: 900; color: #1e3a8a; font-size: 18px;">${displayPosters[0].title}</div>
          `}
        </div>
      ` : displayPosters.length > 1 ? `
        <div class="brochure-posters-grid" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 10px; width: 100%; margin: 0 auto;">
          ${displayPosters.map((p, idx) => `
            <div class="brochure-poster-card" key="poster-${idx}" style="border: 2px solid #d97706; border-radius: 10px; overflow: hidden; background: #ffffff; box-shadow: 0 4px 14px rgba(0,0,0,0.08); padding: 4px;">
              ${p.imageDataUrl ? `
                <img src="${p.imageDataUrl}" class="brochure-poster-img" style="max-height: 290px; width: 100%; object-fit: contain; display: block;" alt="${p.title}" />
              ` : `
    ...
    <div style="flex-shrink: 0; display: flex; flex-direction: column; gap: 5px; margin-top: 4px;">
      ...
      <div style="padding: 4px 10px; background: #f8fafc; border-radius: 8px; border: 1px solid #e2e8f0; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 4px;">
        ...
        <div style="display: flex; gap: 5px; align-items: center; flex-wrap: wrap;">
          <a href="https://youtube.com/@trinetraacademy" target="_blank" style="background: #ef4444; color: white; padding: 2.5px 7px; border-radius: 5px; font-size: 8.5px; font-weight: 800; text-decoration: none; display: inline-flex; align-items: center; gap: 3px;">
            ▶ YouTube
          </a>
          <a href="https://t.me/trinetraacademy" target="_blank" style="background: #0284c7; color: white; padding: 2.5px 7px; border-radius: 5px; font-size: 8.5px; font-weight: 800; text-decoration: none; display: inline-flex; align-items: center; gap: 3px;">
            ✈ Telegram
          </a>
          <a href="https://instagram.com/trinetraacademy" target="_blank" style="background: linear-gradient(135deg, #ec4899, #8b5cf6); color: white; padding: 2.5px 7px; border-radius: 5px; font-size: 8.5px; font-weight: 800; text-decoration: none; display: inline-flex; align-items: center; gap: 3px;">
            📷 Instagram
          </a>
